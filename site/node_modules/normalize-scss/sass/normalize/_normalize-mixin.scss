...
@if $normalize-vertical-rhythm ==null and ($base-line-height !=24px or $base-unit !='em'

  or $h2-font-size !=1.5 * $base-font-size or $h3-font-size !=1.17 * $base-font-size or $h4-font-size !=1 * $base-font-size or $h5-font-size !=0.83 * $base-font-size or $h6-font-size !=0.67 * $base-font-size ) {
